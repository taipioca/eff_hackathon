...
// // This is the API call to Klazify
// var settings = {
//   async: true,
//   crossDomain: true,
...
//   console.log('Klazify:', response);
// });

function Categorization() {
  const [siteCategorization, setSiteCategorization] = useState([]);
...
*/
  ...
  useEffect(() => {
    setSiteCategorization(tracker_data);
    console.log('siteCategorization:', siteCategorization);
  }, [tracker_data]);
        ...
        <Row class="tracker-list-box">
          <Col sm={3}>
            <Nav variant="pills" className="flex-column">
              ...
              {siteCategorization.map((datas, index) => (
                <Nav.Item key={index}>
